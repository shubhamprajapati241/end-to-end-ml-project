...
class DataTransformationConfig:
    preprocessor_obj_file_path = os.path.join("artifact", "preprocesstor.pki")
...
class DataTransformation:
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            precessing_obj = self.get_data_transformer_object()
            ...
            logging.info(f"Applying preprocessing object on training dataram and testing dataframe.")
            ...
            logging.info("Saved precessing object.")

            save_object(
                file_path = self.data_transformation_config.preprocessor_obj_file_path, obj = precessing_obj
            )
